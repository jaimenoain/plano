-- Update get_feed RPC to include is_verified_architect in user_data
...
-- Create get_building_reviews RPC to fetch reviews for a specific building with verification status
