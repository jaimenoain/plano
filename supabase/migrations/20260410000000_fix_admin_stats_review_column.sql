-- Fix admin stats RPC to use correct column for reviews (content instead of review)
-- Replaces usage of l.review with l.content in the user leaderboard section
