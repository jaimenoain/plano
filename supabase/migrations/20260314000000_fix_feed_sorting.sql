-- Update get_main_feed to sort by edited_at to ensure recently updated items (like ratings added to existing watchlist entries) appear at the top.
...
BEGIN
  ...
  WHERE
    ...
    AND status IN ('review', 'watchlist', 'watched')
