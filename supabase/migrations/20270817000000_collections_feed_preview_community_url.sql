-- Add buildings.community_preview_url to get_collections_feed preview JSON so client can
-- resolve images like FeedActivityCard (main path + community fallback). Apply via SQL Editor.
        ...
        FROM (
          SELECT
            jsonb_build_object(
              ...
              'community_preview_url', b3.community_preview_url
            ) AS obj,
            ci3.order_index
