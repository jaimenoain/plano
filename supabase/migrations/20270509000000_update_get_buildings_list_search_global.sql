-- Update get_buildings_list function to allow global search (ignoring bounds when query is present)
-- Migration ID: 20270509000000_update_get_buildings_list_search_global.sql
