-- FIX-1: Include building hero URL in get_feed building_data (matches get_suggested_posts;
-- enables FeedActivityCard Rule 0 when buildings have main_image_url set).
