-- Fix Retention Analysis source and Add Follows/Leaderboard Metrics
-- Updates get_admin_dashboard_stats to include daily follows, new leaderboard metrics, and recent users
