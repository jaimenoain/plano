...
-- 1. Sanitize the Data
-- This physically removes the cause of the crash from the table.
UPDATE films SET release_date = NULL WHERE release_date = '';

-- 2. Harden the Function
-- Replace the NULLIF casting logic with a Regex check. This prevents the database from ever attempting to cast a bad string.
