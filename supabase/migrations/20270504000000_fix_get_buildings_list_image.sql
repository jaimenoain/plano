-- Fix get_buildings_list function to use main_image_url computed column
-- Migration ID: 20270504000000_fix_get_buildings_list_image.sql
...
BEGIN
  ...
  -- 2. Parse Filters (Copied from get_map_clusters_v2)
  ...
  SELECT
    ...
    b.name,
    b.slug,
    main_image_url(b) as image_url, -- Fixed: Use computed column function
