-- Fix for Group Stats Logic: Add sessionCount to stats cache
-- This migration updates the update_group_stats function to include sessionCount in the cached JSON.
