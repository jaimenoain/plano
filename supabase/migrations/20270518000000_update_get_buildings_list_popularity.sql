-- Update get_buildings_list function to support popularity sorting and return popularity_score/tier_rank
-- Migration ID: 20270518000000_update_get_buildings_list_popularity.sql

-- Drop the function first to ensure clean update (required due to return type change)
