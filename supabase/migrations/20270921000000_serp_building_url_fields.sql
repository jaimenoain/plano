-- Migration: serp_building_url_fields
-- Purpose: Expose short_id + locality slugs from get_buildings_list and search_buildings_v2
--          so Search SERP rows can link to /architecture/:cc/:city/:id/:slug URLs.
