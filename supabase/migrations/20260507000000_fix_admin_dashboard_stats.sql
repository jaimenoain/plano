-- Fix Admin Dashboard Stats: Restore Logic & Fix Table References
-- 1. Restore correct response shape (activity_trends object vs array)
-- 2. Fix table reference: log -> user_buildings
-- 3. Restore test_user/admin filtering
-- 4. Maintain SECURITY DEFINER and is_admin() check
