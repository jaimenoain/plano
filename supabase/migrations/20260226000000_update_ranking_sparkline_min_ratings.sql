-- Fix for Ranking Context Sparkline Data Source (Update: Min 2 Ratings)
...
-- NEW: Excludes films that have less than 2 ratings (must be rated by at least 2 distinct members).
