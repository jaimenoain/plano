-- Card system Phase 1: expose author follower counts in feed RPC `user_data` for `CardSpec` / prominence.
-- Apply in Supabase SQL Editor after prior feed migrations.
