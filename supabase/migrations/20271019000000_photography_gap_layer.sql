-- Phase 2 — Photography map: gap layer support in get_map_clusters_v3
--
-- Adds `photos_count` to the return shape and `photography_gaps` / `gap_photo_counts` to filter_criteria.
