...
Use this checklist for design-system work. During the **refinement programme** ([the archived roadmaps](roadmaps/)), agents complete **§1–§7 only** at programme end (see ROADMAP “Automated verification”); **§8 Sign-Off is not required** (no human gate).
