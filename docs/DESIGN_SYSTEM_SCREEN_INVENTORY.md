...
**Refinement programme:** Family-level polish (R0–R9) is **complete** — see [the archived roadmaps](roadmaps/). **Remaining surfaces** (P0–P10) is **complete** (2026-05-24) — all 50 gap routes audited; see [REMAINING_SURFACES_ROADMAP.md](REMAINING_SURFACES_ROADMAP.md) summary.
...
**Refinement** (layout + typography + kit fidelity — see [the archived roadmaps](roadmaps/)):
