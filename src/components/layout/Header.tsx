...
export function Header({
  ...
  if (effectiveVariant === 'home') {
    centerContent = (
      <Link to="/" className="min-w-0">
        <PlanoLogo className="text-lg md:text-2xl text-text-primary shrink-0" />
      </Link>
    );
  ...
  return (
    <header className="fixed top-0 right-0 z-40 left-0 bg-surface-default border-b border-border-default h-16 px-4 transition-all duration-300">
      <div className={cn(
