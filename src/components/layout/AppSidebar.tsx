      ...
      <SidebarMenuItem>
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button className="flex w-full items-center gap-3 px-8 py-3 text-sm text-white/60 hover:text-white transition-colors duration-150 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-brand-accent focus-visible:ring-offset-2 focus-visible:ring-offset-surface-inverse">
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-brand-accent focus-visible:ring-offset-2 focus-visible:ring-offset-surface-inverse",
      )}
  ...
  return (
    ...
    >
      ...
      <SidebarHeader className="flex flex-row items-center justify-between px-8 py-6 border-b border-white/10">
        <Link
          to="/"
          className="flex items-center focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-brand-accent focus-visible:ring-offset-2 focus-visible:ring-offset-surface-inverse rounded-sm"
        >
      ...
      <SidebarContent className="py-6">
        ...
        {showAccountExtras ? (
          <SidebarGroup className="p-0! mt-6 pt-6 border-t border-white/10">
            <p className="px-8 pb-2 text-[11px] font-medium uppercase tracking-widest text-white/40">
              Account
            </p>
            <SidebarGroupContent>
              <SidebarMenu className="gap-0">
