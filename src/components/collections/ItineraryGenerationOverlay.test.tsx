...
describe("ItineraryGenerationOverlay", () => {
  ...
  it("renders the first message initially", () => {
    ...
    expect(screen.getByText("Analyzing geographic zones...")).toBeInTheDocument();
  });
  ...
  it("cycles through messages over time", () => {
    ...
    expect(screen.getByText("Plotting the perfect route...")).toBeInTheDocument();
  ...
  it("does not render content when closed", () => {
    ...
    expect(screen.queryByText("Analyzing geographic zones...")).not.toBeInTheDocument();
  });
  ...
  it("resets message index when closed and reopened", () => {
      ...
      expect(screen.queryByText("Plotting the perfect route...")).not.toBeInTheDocument();
