...
const CarouselContent = React.forwardRef(({ className, ...props }, ref) => {
    ...
    return (_jsx("div", { ref: carouselRef, className: "overflow-hidden min-w-0", children: _jsx("div", { ref: ref, className: cn("flex", orientation === "horizontal" ? "-ml-4" : "-mt-4 flex-col", className), ...props }) }));
});
...
const CarouselPrevious = React.forwardRef(({ className, variant = "ghost", size = "icon-md", ...props }, ref) => {
    const { orientation, scrollPrev, canScrollPrev } = useCarousel();
    return (_jsxs(Button, { ref: ref, variant: variant, size: size, className: cn("absolute", orientation === "horizontal"
...
const CarouselNext = React.forwardRef(({ className, variant = "ghost", size = "icon-md", ...props }, ref) => {
