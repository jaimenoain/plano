        ...
        <DialogContent>
            ...
            <div className="grid gap-4 py-4">
                <RadioGroup value={newArchitectType} onValueChange={(v: string) => setNewArchitectType(v as "individual" | "studio")}>
                    <div className="flex items-center space-x-2 border border-border-default p-3 rounded-sm cursor-pointer hover:bg-surface-muted/50" onClick={() => setNewArchitectType('individual')}>
                        <RadioGroupItem value="individual" id="r1" />
                        <Label htmlFor="r1" className="cursor-pointer">Individual Architect</Label>
                    </div>
                    <div className="flex items-center space-x-2 border border-border-default p-3 rounded-sm cursor-pointer hover:bg-surface-muted/50" onClick={() => setNewArchitectType('studio')}>
