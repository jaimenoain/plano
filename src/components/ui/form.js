...
const FormLabel = React.forwardRef(({ className, ...props }, ref) => {
    ...
    return _jsx(Label, { ref: ref, className: cn(error && "text-feedback-destructive", className), htmlFor: formItemId, ...props });
});
...
const FormDescription = React.forwardRef(({ className, ...props }, ref) => {
    ...
    return _jsx("p", { ref: ref, id: formDescriptionId, className: cn("text-xs text-text-secondary", className), ...props });
});
...
const FormMessage = React.forwardRef(({ className, children, ...props }, ref) => {
    ...
    return (_jsx("p", { ref: ref, id: formMessageId, className: cn("text-xs text-feedback-destructive", className), ...props, children: body }));
});
