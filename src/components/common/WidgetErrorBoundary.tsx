...
function WidgetErrorFallback({ resetErrorBoundary }: FallbackProps) {
  return (
    <div className="flex w-full flex-col items-center justify-center rounded-sm border border-border-default bg-surface-card p-6 text-center shadow-none">
      <AlertTriangle className="mb-2 h-6 w-6 text-feedback-destructive" />
