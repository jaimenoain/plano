 ...
 * Cells with an `onClick` render as buttons; the rest are inert figures.
 * Shared by profile and entity (person/company) pages; takes 2–4 cells.
 */
      ...
      {cells.map((cell, index) => {
        ...
        return cell.onClick ? (
          <button
            ...
            className={`${padClass} transition-opacity hover:opacity-60 active:opacity-60`}
          >
