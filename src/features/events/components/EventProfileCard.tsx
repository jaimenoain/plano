...
export function EventProfileCard({
  ...
  return (
    <Link
      ...
      className={cn(
        "flex gap-3 py-3 transition-opacity hover:opacity-80 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:ring-offset-2",
        className,
      )}
    >
