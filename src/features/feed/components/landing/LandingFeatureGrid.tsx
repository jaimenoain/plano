...
export const LandingFeatureGrid = () => {
  return (
    <div className="grid grid-cols-1 gap-4 md:grid-cols-12">
      ...
      <div className="col-span-1 md:col-span-4 flex flex-col justify-between rounded-xl border border-border-default bg-surface-card p-6 shadow-sm">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between rounded-md border border-border-default bg-surface-muted/30 p-2.5">
      ...
      <div className="col-span-1 md:col-span-4 flex flex-col justify-between rounded-xl border border-border-default bg-surface-card p-6 shadow-sm">
        ...
        <div className="relative mt-4 flex h-32 flex-col justify-end">
            {/* Background Layers */}
            <div className="absolute bottom-2 left-2 right-2 h-16 rounded-lg border border-border-default bg-surface-muted/40" />
            <div className="absolute bottom-1 left-1 right-1 h-16 rounded-lg border border-border-default bg-surface-muted/60" />

            {/* Top Layer */}
            <div className="relative z-10 flex items-center justify-between rounded-lg border border-border-default bg-surface-default p-3 shadow-sm">
              <div>
              ...
              <div className="flex -space-x-2">
                <div className="h-6 w-6 rounded-full bg-slate-200 ring-2 ring-surface-default dark:bg-slate-700" />
                <div className="h-6 w-6 rounded-full bg-slate-300 ring-2 ring-surface-default dark:bg-slate-600" />
                <div className="h-6 w-6 rounded-full bg-slate-400 ring-2 ring-surface-default dark:bg-slate-500" />
              </div>
            </div>
        </div>
      </div>
      ...
      <div className="col-span-1 md:col-span-4 flex flex-col justify-between rounded-xl border border-border-default bg-surface-card p-6 shadow-sm">
        ...
        <div className="mt-auto">
            <div className="flex items-center gap-3 rounded-lg border border-border-default bg-surface-default p-3 shadow-sm">
