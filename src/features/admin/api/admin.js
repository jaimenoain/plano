...
export async function fetchAdminDashboardStats() {
    ...
    const [{ data: pulseData, error: _pulseError }, { data: trendsData, error: _trendsError }, { data: leaderboardsData, error: _leaderboardsError }, { data: contentData, error: _contentError }, { data: retentionData, error: _retentionError }, { data: notificationsData, error: _notificationsError }, 
    // Direct queries for counts
    { count: totalBuildings, error: _buildingsError }, { count: totalReviews, error: _reviewsError }, { count: totalPhotos, error: _photosError }, { count: pendingReports, error: _reportsError },] = await Promise.all([
...
export async function fetchPhotoHeatmapData() {
