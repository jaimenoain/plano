          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            <div className="space-y-1">
              ...
              <select
                ...
                className="h-8 w-full rounded-sm border border-border-default bg-surface-card px-2 text-sm text-text-primary focus:outline-none focus:ring-1 focus:ring-brand-primary"
              >
