...
export const MapProvider = ({ children }) => {
    ...
    const primeContactCache = useCallback((contacts) => {
    ...
    return _jsx(MapContext.Provider, { value: value, children: children });
};
