            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-1 top-1/2 -translate-y-1/2 flex h-11 min-h-11 w-11 min-w-11 items-center justify-center rounded-sm text-text-secondary hover:text-text-primary focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-brand-primary"
