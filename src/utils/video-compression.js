...
export class VideoCompressionService {
    ...
    static async compressVideo(file, onProgress) {
        ...
        try {
            ...
            // Convert to File
            const blob = new Blob([typeof data === "string" ? data : new Uint8Array(data)], { type: "video/mp4" });
...
Object.defineProperty(VideoCompressionService, "instance", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: null
});
Object.defineProperty(VideoCompressionService, "isLoading", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: false
