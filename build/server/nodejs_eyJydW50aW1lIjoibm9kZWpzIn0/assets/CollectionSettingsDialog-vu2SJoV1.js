  ...
  const handleExportData = async () => {
    try {
      ...
      const rows = exportRows.map((item) => {
        ...
        const credits = ((_a = building == null ? void 0 : building.building_credits) == null ? void 0 : _a.filter(
          (c) => c.credit_tier === "primary" && (c.status === "active" || c.status === "verified")
        ).map((c) => {
          var _a2, _b2;
          const pn = (_a2 = c.person) == null ? void 0 : _a2.name;
          const cn = (_b2 = c.company) == null ? void 0 : _b2.name;
