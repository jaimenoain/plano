// Barrel entry for design-sync (synthesized DS library surface).
// Re-exports every shadcn/ui primitive so the converter bundles them into
// window.Plano. Excludes: toaster.tsx (Toaster name collides with sonner.tsx),
// LocationInput.tsx + style-select.tsx (Google-Maps / app-data coupled).
...
export * from "../src/components/ui/michelin-rating-input";
...
export * from "../src/components/ui/VideoPlayer";
